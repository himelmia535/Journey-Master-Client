...
const AddTouristsSpot = () => {
    const handleAddCoffee = event => {
        ...
        const newTouristsSpot = { name, country, cost, seasonality, travel_time, totaVisitorsPerYear, username, useremail, message, location, photo }
    ...
    return (
        <div className="bg-[#F4F3F0] p-24 -mt-12">
            <h2 className="text-xl font-extrabold md:text-3xl">Add a Tourists Spot</h2>
            <form onSubmit={handleAddCoffee}>
                ...
                <div className="md:flex mb-6">
                    ...
                    <div className="form-control md:w-1/2 ml-4">
                        <label className="label">
                            <span className="label-text font-medium">Total Visitors Per Year</span>
                        </label>
                        <label className="input-group">
                ...
                <input type="submit" value="Add Spot" className="btn text-xl w-full bg-slate-500 hover:bg-green-600 text-white" />
