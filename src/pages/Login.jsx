...
const Login = () => {
  ...
  <div className="hero-content flex-col ">
    <div className="text-center mb-4 lg:text-left">
      <h1 className="text-xl lg:text-5xl font-bold">Login to your account!</h1>
    </div>
    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">

      {/* Social Media */}
      <div className="m-3">
      <button onClick={()=>handleSocialLogin(googleLogin)} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full mt-3 mb-2 p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
